...
"preprocessor"
"pull-core"
"tidying-media-container-base"
"rejoice"
"pull-file"
"espurify"
"kuromoji"
"ender-bootstrap-base"
"topcoat-theme-mobile-light"
"bash.origin"
"babel-plugin-import"
"odbc"
"git-repo-version"
...
"rho"
"regression"
"kylpo-display-component-factory"
"detectcss"
"detective-es6"
"karma-mocha-debug"
"nunjucks-markdown"
...
for i in "${arr[@]}"
do
  curl -X GET https://api.npms.io/v2/package/$i | jq -r '. | [ .collected.metadata.links.repository, .collected.github.starsCount, .collected.github.forksCount, .collected.github.subscribersCount, .collected.source.coverage, (.collected.source.linters | length), .collected.npm.dependentsCount, .collected.npm.starsCount, (.collected.metadata.maintainers | length), (.collected.metadata.contributors | length), (.collected.metadata.dependencies | length), .collected.metadata.license, .collected.github.issues.count, .collected.github.issues.openCount ] | @csv' >> data.csv
done
